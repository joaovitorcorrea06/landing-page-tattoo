...
const Section2 = ({animations2i1, animations2i2,animations2i3}) => {
  return (
    <div className="hero min-h-screen bg-base-200" id='section2'>
      <div className="container my-24 px-6 mx-auto">

        <section className="mb-32 text-white-800 text-center">

          <h2 className="text-3xl font-bold mb-12 text-decoration-line: underline">Testimonials</h2>

          <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
            <div className={`mb-12 md:mb-0 ${animations2i1} commentHover`} id='section2Img1'>
            ...
            <div className={`mb-12 md:mb-0 ${animations2i2} commentHover`} id='section2Img2'>
              <div className="flex justify-center mb-6">
            ...
            <div className={`mb-0 ${animations2i3} commentHover`} id='section2Img3'>
              <div className="flex justify-center mb-6">
