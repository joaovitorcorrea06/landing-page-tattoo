...
const Section5 = ({animations5i1,animations5i2,animations5i3 }) => {

  // const [animation1, setAnimation1] = useState('hidden');
  // const [animation2, setAnimation2] = useState('hidden');
  // const [animation3, setAnimation3] = useState('hidden');
  ...
  //      setAnimation1('show')
  //    } else {setAnimation1('hidden')}
  //   if (document.documentElement.scrollTop > 4500) {
  //      setAnimation2('show')
  //    } else {setAnimation2('hidden')}
  //   if (document.documentElement.scrollTop > 5000) {
  //      setAnimation3('show')
  //    } else {setAnimation3('hidden')}
  //  }
   

  return (
    <div className="hero min-h-screen bg-base-content" style={{borderTop: '1px solid black'}} id='section5'>
      <div className="container my-24 px-6 mx-auto">
        <section className="mb-32 text-gray-800">
          <h2 className="text-2xl font-bold mb-12 text-center">Latest articles</h2>

          <div className={`flex flex-wrap mb-12 ${animations5i1} section5Hover`} id='section5img1'>
            ...
            <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pl-6">
              <h3 className="text-2xl font-bold mb-4">Thats the news!</h3>
              ...
              <p className="text-gray-500 mb-6 hover:text-black">
          ...
          <div className={`flex flex-wrap lg:flex-row-reverse mb-12 ${animations5i2} section5Hover`} id='section5img2'>
            <div className={`grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pr-6 mb-6 lg:mb-0 `} >
              <div className="relative overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg"
                style={{backgroundPosition: '50%'}}data-mdb-ripple="true" data-mdb-ripple-color="light">
          ...
          <div className={`flex flex-wrap ${animations5i3} section5Hover`} id='section5img3'>
            <div className={`grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pr-6 mb-6 lg:mb-0 `} >
              <div className="relative overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg"
                style={{backgroundPosition: '50%'}} data-mdb-ripple="true" data-mdb-ripple-color="light">
